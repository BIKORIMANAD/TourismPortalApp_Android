...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> implements Filterable {
    ...
    List<Trips> pets, tripsFilter;
    private Context context;
    private RecyclerViewClickListener mListener;
    CustomFilter filter;

    public Adapter(List<Trips> pets, Context context, RecyclerViewClickListener listener) {
        this.pets = pets;
        this.tripsFilter = pets;
    ...
    public Filter getFilter() {
        if (filter==null) {
            filter=new CustomFilter((ArrayList<Trips>) tripsFilter,this);
