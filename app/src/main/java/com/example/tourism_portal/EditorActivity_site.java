 ...
 */
public class EditorActivity_site extends AppCompatActivity {
    ...
    private ApiInterface_site apiInterfaceSite;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_editor_site);
        ...
        mBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(EditorActivity_site.this, date, myCalendar
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            Glide.with(EditorActivity_site.this)
                    .load(picture)
            ...
            getSupportActionBar().setTitle("Add a tourist");
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditorActivity_site.this);
                dialog.setMessage("Delete this site?");
    ...
    private void postData(final String key) {
        ...
        Call<Site> call = apiInterfaceSite.insertPet(key, name, species, breed, gender, birth, picture);
        ...
        call.enqueue(new Callback<Site>() {
            ...
            public void onResponse(Call<Site> call, Response<Site> response) {
                ...
                Log.i(EditorActivity_site.class.getSimpleName(), response.toString());
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(EditorActivity_site.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Site> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditorActivity_site.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void updateData(final String key, final int id) {
        ...
        Call<Site> call = apiInterfaceSite.updatePet(key, id,name, species, breed, gender, birth, picture);
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Site> call = apiInterfaceSite.deletePet(key, id, pic);
