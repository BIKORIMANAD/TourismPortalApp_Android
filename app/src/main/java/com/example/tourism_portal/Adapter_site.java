...
public class Adapter_site extends RecyclerView.Adapter<Adapter_site.MyViewHolder> implements Filterable {

    List<Site> pets, siteFilter;
    private Context context;
    private RecyclerViewClickListener mListener;
    CustomFilter_site filter;

    public Adapter_site(List<Site> pets, Context context, RecyclerViewClickListener listener) {
        this.pets = pets;
        this.siteFilter = pets;
    ...
    public Filter getFilter() {
        if (filter==null) {
            filter=new CustomFilter_site((ArrayList<Site>) siteFilter,this);
